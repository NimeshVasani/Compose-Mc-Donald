        ...
        return Menu(
            ...
            menuItems = listOf(
                ...
                MenuItem(
                    ...
                    image = "https://raw.githubusercontent.com/nimesh-vasani/McCompose/main/app/src/main/res/drawable-nodpi/" + "menu_item_mcflurry_with_oreo_cookies.png" + "?raw=true",
                    price = getRandomPrice(),
                    categoryId = 6,quantity = 0
                ),
                MenuItem(
                    ...
                    image = "https://raw.githubusercontent.com/-vasani/compose-mc-donald/main/app/src/main/res/drawable-nodpi/" + "menu_item_baked_apple_pie.png" + "?raw=true",
                    price = getRandomPrice(),
                    categoryId = 6,quantity = 0
                ),
                MenuItem(
